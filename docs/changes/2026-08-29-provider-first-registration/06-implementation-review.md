...
| IR-003 | Suggestion | Migration Hardening | The Must-level authority, NULL/blank metadata, and partial-owner constraints are resolved. Migration 61 still permits some registration state/authority combinations that runtime does not ordinarily produce. | `appview/migrations/000061_provider_first_registration.up.sql`; `appview/internal/db/provider_registration_migration_test.go`; AC-027, IT-005, IT-021 | Consider exhaustively constraining each registration state against absent and complete authority in a follow-up. |
