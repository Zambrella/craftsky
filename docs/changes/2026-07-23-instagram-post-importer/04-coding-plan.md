...
| Review UI | No importer UI | Public-content acknowledgement, virtualized/filterable/selectable review, automatic first-image previews from existing sanitized media, expandable remaining images, editable captions, warnings/counts, destination confirmation | BR-001, BR-004, FR-010 | AT-001, AT-004, IT-008 |
