...
| IT-009 | FR-020, NFR-008 | AC-011, AC-012, AC-021 | Reversible post-provenance/profile-order migration. | Isolated real Postgres with all migrations through 000031 applied | Assert migration versions are uniquely paired, then run up/down/up 000032 and inspect schema/indexes | Migration discovery succeeds; existing rows default ordinary; new fields/indexes are reversible | `appview/internal/db/migration_files_test.go`, `appview/internal/db/instagram_import_migration_test.go` |
