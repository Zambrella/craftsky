...
func baseV1RoutePolicies() []RoutePolicy {
	return []RoutePolicy{
		...
		{Method: "GET", PathPattern: "/v1/profiles/me/pins", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		...
		{Method: "POST", PathPattern: "/v1/profiles/{handleOrDid}/mutes", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "DELETE", PathPattern: "/v1/profiles/{handleOrDid}/mutes", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "POST", PathPattern: "/v1/profiles/{handleOrDid}/blocks", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "DELETE", PathPattern: "/v1/profiles/{handleOrDid}/blocks", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "GET", PathPattern: "/v1/profiles/me/mutes", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "GET", PathPattern: "/v1/profiles/me/blocks", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true},
		...
		{Method: "GET", PathPattern: "/v1/languages/preferences", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "PUT", PathPattern: "/v1/languages/preferences", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "POST", PathPattern: "/v1/languages/preferences/initialize", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "POST", PathPattern: "/v1/notifications/devices", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "DELETE", PathPattern: "/v1/notifications/devices/{accountSubscriptionId}", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "POST", PathPattern: "/v1/blobs/images", RateClass: RateClassUpload, BodyKind: BodyUpload, AuthRequired: true},
		{Method: "PUT", PathPattern: "/v1/scheduled-post-media/{mediaId}", RateClass: RateClassUpload, BodyKind: BodyUpload, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "GET", PathPattern: "/v1/scheduled-post-media/{mediaId}", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "DELETE", PathPattern: "/v1/scheduled-post-media/{mediaId}", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "POST", PathPattern: "/v1/scheduled-posts", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "GET", PathPattern: "/v1/scheduled-posts", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "GET", PathPattern: "/v1/scheduled-posts/{id}", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "PUT", PathPattern: "/v1/scheduled-posts/{id}", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "DELETE", PathPattern: "/v1/scheduled-posts/{id}", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "POST", PathPattern: "/v1/scheduled-posts/{id}/publication", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true, CurrentMemberRequired: true},
		...
		{Method: "POST", PathPattern: "/v1/posts/{did}/{rkey}/saves", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "DELETE", PathPattern: "/v1/posts/{did}/{rkey}/saves", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "PUT", PathPattern: "/v1/posts/{did}/{rkey}/pin", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "DELETE", PathPattern: "/v1/posts/{did}/{rkey}/pin", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true, CurrentMemberRequired: true},
		{Method: "GET", PathPattern: "/v1/saved-posts", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "GET", PathPattern: "/v1/saved-post-folders", RateClass: RateClassRead, BodyKind: BodyNoBody, AuthRequired: true},
		{Method: "POST", PathPattern: "/v1/saved-post-folders", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "PATCH", PathPattern: "/v1/saved-post-folders/{folderId}", RateClass: RateClassWrite, BodyKind: BodyDefaultJSON, AuthRequired: true},
		{Method: "DELETE", PathPattern: "/v1/saved-post-folders/{folderId}", RateClass: RateClassWrite, BodyKind: BodyNoBody, AuthRequired: true},
