...
func TestCraftskyProfile_DeleteHardDeletesCausedNotifications(t *testing.T) {
	...
	idx := index.NewCraftskyProfile(pool, noopBackfiller{}, testLogger(), notifications.NewActorDeletionService(pool))
	create := tap.Event{
		URI: "at://did:plc:actor/social.craftsky.actor.profile/self", CID: "profile-cid",
		DID: "did:plc:actor", Rkey: "self", Collection: "social.craftsky.actor.profile", Action: "create",
		Record: json.RawMessage(`{"crafts":["knitting"]}`),
	}
	if err := idx.Handle(context.Background(), create); err != nil {
		t.Fatal(err)
	...
	if _, err := pool.Exec(context.Background(), `
		...
		VALUES('00000000-0000-0000-0000-000000000001','did:plc:viewer','did:plc:actor','follow','s','u','c','r','everyone',false,true,'active',now(),now(),now(),now());
		INSERT INTO push_installations(id,device_id,platform,fcm_token) VALUES('10000000-0000-0000-0000-000000000001','d','ios','t');
		INSERT INTO push_account_subscriptions(id,installation_id,account_did,routing_id) VALUES('20000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','did:plc:viewer','30000000-0000-0000-0000-000000000001');
		INSERT INTO push_deliveries(id,notification_id,account_subscription_id,status,next_attempt_at,deadline_at) VALUES('40000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','pending',now(),now()+interval '6 hours')`); err != nil {
		t.Fatal(err)
	}
