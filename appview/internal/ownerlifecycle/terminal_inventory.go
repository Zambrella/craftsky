...
var terminalDIDInventory = []TerminalDIDEntry{
	...
	deleteDID("moderation_cases", "owner_did", "owner", "id"),
	deleteDID("moderation_cases", "subject_did", "subject", "id"),
	deleteDID("moderation_account_standings", "owner_did", "owner", "owner_did"),
	deleteDID("moderation_case_strikes", "owner_did", "owner", "case_id"),
