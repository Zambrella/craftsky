...
var terminalQueryInventory = []struct {
	...
	{"push claim and pre-send recheck", "push/dispatcher.go", []string{"claimOne", "currentDeliveryStatus", "cancelEligibilityInvalid", "appview_owner_is_terminal(n.recipient_did)", "appview_owner_is_terminal(n.actor_did)"}},
