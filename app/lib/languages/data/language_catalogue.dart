...
final Set<String> supportedLanguageTags = Set.unmodifiable(
  _v1Tags.split(RegExp(r'\s+')).where((value) => value.isNotEmpty),
);

const _englishLabels = <String, String>{
  'aa': 'Afar',
  'ab': 'Abkhazian',
  'ae': 'Avestan',
  'af': 'Afrikaans',
...
String languageLabel(String tag) => _englishLabels[tag] ?? tag;
