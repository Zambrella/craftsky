...
@ProviderFor(notificationResolutionRepository)
final notificationResolutionRepositoryProvider =
    NotificationResolutionRepositoryProvider._();

final class NotificationResolutionRepositoryProvider
    extends
        $FunctionalProvider<
          ...
          NotificationResolutionRepository
        >
    with $Provider<NotificationResolutionRepository> {
  NotificationResolutionRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'notificationResolutionRepositoryProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$notificationResolutionRepositoryHash();

  @$internal
  @override
  $ProviderElement<NotificationResolutionRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  NotificationResolutionRepository create(Ref ref) {
    return notificationResolutionRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(NotificationResolutionRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<NotificationResolutionRepository>(
        value,
      ),
    );
  }
...
String _$notificationResolutionRepositoryHash() =>
    r'79e59b7b8894b2e659dea396d70cbf5300b702a0';
